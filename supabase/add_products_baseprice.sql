...
-- Men's Shirts
INSERT INTO products (name, description, category, gender, base_price, images, is_active, is_featured) VALUES
...
-- Men's Shirt variants (sizes: S,M,L,XL, colors: White)
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'S', 'White', 50, base_price, true FROM products WHERE category = 'shirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'M', 'White', 50, base_price, true FROM products WHERE category = 'shirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'L', 'White', 50, base_price, true FROM products WHERE category = 'shirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'XL', 'White', 50, base_price, true FROM products WHERE category = 'shirts' AND gender = 'men';

-- Men's Pants variants (sizes: 28,30,32,34)
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '28', 'Black', 40, base_price, true FROM products WHERE category = 'pants' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '30', 'Black', 40, base_price, true FROM products WHERE category = 'pants' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '32', 'Black', 40, base_price, true FROM products WHERE category = 'pants' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '34', 'Black', 40, base_price, true FROM products WHERE category = 'pants' AND gender = 'men';

-- Men's T-Shirt variants
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'S', 'Black', 80, base_price, true FROM products WHERE category = 'tshirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'M', 'Black', 80, base_price, true FROM products WHERE category = 'tshirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'L', 'Black', 80, base_price, true FROM products WHERE category = 'tshirts' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'XL', 'Black', 80, base_price, true FROM products WHERE category = 'tshirts' AND gender = 'men';

-- Men's Shoes variants (sizes: 7,8,9,10)
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '7', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '8', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '9', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'men';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '10', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'men';

-- Women's Kurti variants
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'S', 'Pink', 30, base_price, true FROM products WHERE category = 'kurtis' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'M', 'Pink', 30, base_price, true FROM products WHERE category = 'kurtis' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'L', 'Pink', 30, base_price, true FROM products WHERE category = 'kurtis' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, 'XL', 'Pink', 30, base_price, true FROM products WHERE category = 'kurtis' AND gender = 'women';

-- Women's Jeans variants
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '26', 'Blue', 40, base_price, true FROM products WHERE category = 'jeans' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '28', 'Blue', 40, base_price, true FROM products WHERE category = 'jeans' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '30', 'Blue', 40, base_price, true FROM products WHERE category = 'jeans' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '32', 'Blue', 40, base_price, true FROM products WHERE category = 'jeans' AND gender = 'women';

-- Women's Shoes variants
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '5', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '6', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '7', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'women';
INSERT INTO product_variants (product_id, size, color, stock, price, is_active)
SELECT id, '8', 'Black', 25, base_price, true FROM products WHERE category = 'shoes' AND gender = 'women';

-- Verify products
SELECT id, name, category, gender, base_price FROM products ORDER BY gender, category;
